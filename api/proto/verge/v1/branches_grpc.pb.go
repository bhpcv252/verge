...
const (
	BranchService_CreateBranch_FullMethodName  = "/verge.v1.BranchService/CreateBranch"
	BranchService_GetBranch_FullMethodName     = "/verge.v1.BranchService/GetBranch"
	BranchService_ListBranches_FullMethodName  = "/verge.v1.BranchService/ListBranches"
	BranchService_AdvanceBranch_FullMethodName = "/verge.v1.BranchService/AdvanceBranch"
	BranchService_DeleteBranch_FullMethodName  = "/verge.v1.BranchService/DeleteBranch"
)
...
type BranchServiceClient interface {
	...
	AdvanceBranch(ctx context.Context, in *AdvanceBranchRequest, opts ...grpc.CallOption) (*Branch, error)
...
func (c *branchServiceClient) AdvanceBranch(ctx context.Context, in *AdvanceBranchRequest, opts ...grpc.CallOption) (*Branch, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Branch)
	err := c.cc.Invoke(ctx, BranchService_AdvanceBranch_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BranchServiceServer interface {
	...
	AdvanceBranch(context.Context, *AdvanceBranchRequest) (*Branch, error)
...
func (UnimplementedBranchServiceServer) AdvanceBranch(context.Context, *AdvanceBranchRequest) (*Branch, error) {
	return nil, status.Error(codes.Unimplemented, "method AdvanceBranch not implemented")
}
...
func _BranchService_AdvanceBranch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AdvanceBranchRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BranchServiceServer).AdvanceBranch(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BranchService_AdvanceBranch_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BranchServiceServer).AdvanceBranch(ctx, req.(*AdvanceBranchRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BranchService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "verge.v1.BranchService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AdvanceBranch",
			Handler:    _BranchService_AdvanceBranch_Handler,
		},
		{
	...
	Metadata: "verge/v1/branches.proto",
}
